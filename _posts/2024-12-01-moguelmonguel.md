          ...
          <div class="section-content">
            ...
            <ul class="feature-list">
              <li>
                ...
                해당 논문의 주요 프롬프트 내용은 다음과 같습니다.<br>
                - 어휘 수준: 특정 연령대가 이해할 수 있는 포괄적인 언어 사용을 지정했습니다.<br>
                - 서술 방식: 단순하고 명확한 단어를 사용하고, 복잡한 추론이 필요한 개념을 피하도록 했습니다.<br>
                - 시각적 요소: 명확하게 그림으로 표현 가능한 대상과 상황만을 포함하도록 제한했습니다.<br>
                - 정서적 측면: 긍정적인 표현을 사용하고 해피엔딩으로 마무리하도록 지정했습니다.<br>
                - 내용 구성: 특정 요소(element_1, element_2)에 초점을 맞추고 독자의 상상력을 자극하는 요소를 포함하도록 했습니다.<br><br>
